...
QtObject {
  ...
  property var htofz //an [6][2][512][3]
  property var velX
  property var velY
  property var velZ
  property var hvelX
      ...
      function(ponum, payload) {
          ...
          for (var tofi = 0; tofi < payload["tofs"].length; tofi++) {
            ...
            case 0:
              ...
              case 1:
                ...
                if (dsource.htofz[0][0].length > 512) dsource.htofz[0][0].shift();
                break;
               case 2:
               ...
               case 3:
                 ...
                 if (dsource.htofz[3][0].length > 512) dsource.htofz[3][0].shift();
                 break;
              }
              break;
            case 1:
              ...
              case 0:
                ...
                if (dsource.htofz[0][1].length > 512) dsource.htofz[0][1].shift();
                break;
              case 2:
                dsource.tofz[1][0] = tof.val;
                dsource.htofz[1][0].push([0,payload["time"], tof.val]);
                if (dsource.htofz[1][0].length > 512) dsource.htofz[1][0].shift();
                break;
              case 3:
                dsource.tofz[4][0] = tof.val;
                dsource.htofz[4][0].push([0,payload["time"], tof.val]);
                if (dsource.htofz[4][0].length > 512) dsource.htofz[4][0].shift();
                break;
              }
              break;
            case 2:
              ...
              case 0:
                ...
                if (dsource.htofz[2][0].length > 512) dsource.htofz[2][0].shift();
                break;
              case 1:
                 dsource.tofz[1][1] = tof.val;
                 dsource.htofz[1][1].push([0,payload["time"], tof.val]);
                if (dsource.htofz[1][1].length > 512) dsource.htofz[1][1].shift();
                break;
              case 3:
                dsource.tofz[5][0] = tof.val;
                dsource.htofz[5][0].push([0,payload["time"], tof.val]);
                if (dsource.htofz[5][0].length > 512) dsource.htofz[5][0].shift();
                break;
              }
              break;
            case 3:
              ...
              case 0:
                ...
                if (dsource.htofz[3][1].length > 512) dsource.htofz[3][1].shift();
                break;
              case 1:
                dsource.tofz[4][1] = tof.val;
                dsource.htofz[4][1].push([0,payload["time"], tof.val]);
                if (dsource.htofz[4][1].length > 512) dsource.htofz[4][1].shift();
                break;
              case 2:
                dsource.tofz[5][1] = tof.val;
                dsource.htofz[5][1].push([0,payload["time"], tof.val]);
                if (dsource.htofz[5][1].length > 512) dsource.htofz[5][1].shift();
                break;
              }
              break;
            }
        ...
        if (payload["velocities"] != undefined) {
          for (var veli = 0; veli < payload["velocities"].length; veli++) {
            ...
            if (dsource.hvelY.length > 512) dsource.hvelY.shift();
            dsource.hvelZ.push([0,payload["time"],velZ]);
            if (dsource.hvelZ.length > 512) dsource.hvelZ.shift();
          }
          dsource.velChanged()
        }
